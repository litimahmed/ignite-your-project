export const fr = {
  ...
  about: {
    ...
    titleRest: "VOTRE PARTENAIRE DE DÉVELOPPEMENT DE CONFIANCE",
    description: "Nous sommes une société de développement internationale moderne et professionnelle basée à Oran, Algérie. Avec une expérience avérée dans la livraison de solutions numériques de classe mondiale, notre équipe d'experts combine technologie de pointe et excellence créative pour aider les entreprises du monde entier à réaliser leurs ambitions numériques.",
    tagline1: "PROFESSIONNEL • MODERNE • INTERNATIONAL",
    tagline2: "RECONNU PAR NOS CLIENTS DANS LE MONDE",
