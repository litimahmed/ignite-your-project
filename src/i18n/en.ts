export const en = {
  ...
  about: {
    ...
    titleRest: "YOUR TRUSTED DEVELOPMENT PARTNER",
    description: "We are a professional, modern international development company headquartered in Oran, Algeria. With a proven track record of delivering world-class digital solutions, our expert team combines cutting-edge technology with creative excellence to help businesses across the globe achieve their digital ambitions.",
    tagline1: "PROFESSIONAL • MODERN • INTERNATIONAL",
    tagline2: "TRUSTED BY CLIENTS WORLDWIDE",
